...
const independent=new Set(['augmentor/home','augmentor/voice/control','augmentor/dsh','augmentor/prompts','augmentor/memory','augmentor/diagnostics','updates/check','shutdown'])
