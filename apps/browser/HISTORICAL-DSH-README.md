...
# Historical DSH-only browser guide

This imported guide records the original browser integration. For current
installation and ownership use [the maintained browser README](README.md).
...
The historical releases described here used MIT. Current source uses
[MIT with Augmentor Resale Restriction](LICENSE).
